...
int main(int argc, char **argv)
{
  ...
  nodelay(stdscr, TRUE);
	...
	/robot_b/robotnik_base_control/cmd_vel
	/robot_b/robotnik_base_control/odom
	/robot_b/robotnik_base_hw/emergency_stop std_msgs/Bool
...
///////////////////////////////////////////////////
	...
	*/
	...
	if(suma==3)
	{
		...
		{ 
		if(distance_a_b(pos_x,pos_y,b_pos_x,b_pos_y)==2)
		{
		emergency_stop_msg.data = true;
		...
		*/
		...
		{
		if(distance_a_c(pos_x,pos_y,c_pos_x,c_pos_y)==2)
		{
		emergency_stop_msg.data = true;
		pub_.publish(cmd_vel_msg);
		pub.publish(emergency_stop_msg);
